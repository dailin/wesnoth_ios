...
#else
const SDL_Rect leader_pane_position = {-200,-170,200,170};
#endif
...
#else
//        font::draw_text(&video(),area,font::SIZE_PLUS,font::NORMAL_COLOR,faction,area.x + 110, area.y + 60);
		const SDL_Rect leader_rect = font::draw_text(&video(),area,font::SIZE_TINY,font::NORMAL_COLOR,
                                                     _("Leader: "),area.x, area.y + 65);
		const SDL_Rect gender_rect = font::draw_text(&video(),area,font::SIZE_TINY,font::NORMAL_COLOR,
                                                     _("Gender: "),area.x, leader_rect.y + 30);
        
		font::draw_wrapped_text(&video(),area,font::SIZE_TINY,font::NORMAL_COLOR,
                                _("Recruits: ") + recruit_string.str(),area.x, gender_rect.y + 30,
                                area.w);
        
		leader_combo_.set_location(leader_rect.x + leader_rect.w + 16, leader_rect.y - 5);
		gender_combo_.set_location(leader_rect.x + leader_rect.w + 16, gender_rect.y - 5);
#endif
	}
}
