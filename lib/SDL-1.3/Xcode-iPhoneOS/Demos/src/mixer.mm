...
//    loadSound("trance-loop.ogg", &drums[3]);
...
//    loadSound("ds_china.wav", &drums[0]);
    ...
    NSString *langDataPath = [[NSBundle mainBundle] pathForResource:@"trance-loop" ofType:@"ogg"];	
    
    Mix_Music* const music = Mix_LoadMUS([langDataPath UTF8String]);
